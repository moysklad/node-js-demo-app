...
Это контрактный каркас, а не готовая бонусная система. Перед использованием в рабочем решении вендор должен реализовать хранение участников и балансов, правила скидок, начисление и списание бонусов, обработку продаж и возвратов, идемпотентность и необходимые проверки. Сертификаты и verification endpoints в минимальный пример не входят.
