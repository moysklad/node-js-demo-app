...
- Каждый крупный образец — **модуль** в своем каталоге со своим `README.md`
  (описанием модуля): назначение, карта файлов, платформенные особенности, чеклист адаптации.
- Общий код модуль трогает только в **помеченных точках подключения**: строка или блок с комментарием
...
- Нужно **взять модуль за основу** → прочитайте его `README.md` и найдите точки подключения:
