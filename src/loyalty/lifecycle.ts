...
/**
 * Реакция модуля лояльности на жизненный цикл решения (вызывается из src/api/vendor-endpoint.ts).
 *
 ...
 * Приостановка (Suspend) настройки лояльности в МоемСкладе не удаляет — на нее модуль не реагирует.
 */
